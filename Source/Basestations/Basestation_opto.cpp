...
void BasestationConnectBoard_opto::getInfo()
{
...
BasestationConnectBoard_opto::BasestationConnectBoard_opto(Basestation* bs) : BasestationConnectBoard(bs)
{
	getInfo();
}
...
bool Basestation_opto::open()
{
	...
	if (errorCode == Neuropixels::SUCCESS)
	{
		...
		basestationConnectBoard = new BasestationConnectBoard_opto(this);
...
Basestation_opto::~Basestation_opto()
{
...
void Basestation_opto::setSyncAsInput()
{
...
Array<int> Basestation_opto::getSyncFrequencies()
{
	return syncFrequencies;
}

void Basestation_opto::setSyncAsOutput(int freqIndex)
{
...
int Basestation_opto::getProbeCount()
{
	return probes.size();
}

float Basestation_opto::getFillPercentage()
{
	float perc = 0.0;
...
void Basestation_opto::startAcquisition()
{
	for (auto probe : probes)
	{
...
void Basestation_opto::stopAcquisition()
{
	for (auto probe : probes)
	{
...
void Basestation_opto::updateBscFirmware(File file)
{
...
void Basestation_opto::updateBsFirmware(File file)
{
