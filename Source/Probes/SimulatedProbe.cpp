                                ...
                                int SN) : Probe (bs, hs, fl, dock)
{
    ...
    if (type == ProbeType::NP1 || type == ProbeType::NHP10 || type == ProbeType::NHP25 || type == ProbeType::NHP45 || type == ProbeType::UHD1 || type == ProbeType::UHD2 || type == ProbeType::NHP1)
    {
